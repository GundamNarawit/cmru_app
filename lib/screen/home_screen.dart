          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text('เมื่อวันที่ 25 กรกฎาคม 2567',  style: TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.bold,)),
                  Text('ร่วมประชุมเครือข่ายส่งเสริมการใช้ประโยชน์ทางวิทยาศาสตร์',  style: TextStyle(
 color: Colors.grey,))
                ],
              ),
            ),
